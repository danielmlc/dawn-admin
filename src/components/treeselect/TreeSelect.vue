<template>
<div class="treeSelect"  v-clickoutside="_hiddenBlock">
    <el-input ref="inputText"
        ...
        @focus="_focus" 
        :value="currentValue">
        <i :class="icon" style="line-height:28px;"
            slot="suffix"
            @click="_iconClick">
        </i>
    </el-input>
    <div :class="{'visibility':inputTreeIsVisibe}"  
         ...
         <div class="toolbar" v-if="displaytoolBar">
             <span class="btn-icon" @click="_clear"><i class="el-icon-cancel3"></i>清空</span> | 
             <span class="btn-icon" @click="_reset"><i class="el-icon-spinner2"></i>重新加载</span> 
         </div>
        <el-input
            v-if="filterVisibe"
