              ...
              <div slot="right" >
                    <yl-layout >
                        ...
                        <div slot="secondbox"  class="flexbox" >
                         <!--显示区域-->
                            <yl-list ref="querylistR"
                                     @reload="_reload"
                                    :listOptions="tableInfoConf.listOptions"
                                    :dataList="dataList" 
...
export default {
    ...
    methods:{
                  ...
                  data:params
                        ...
                        if(data.success){
                            if(data.result.resultType===0){
                                  ...
                                  this._afterLoad();
                                  this.dataList=this.extensionObj.table[0];
                            }
                        }
                        else {
        ...
        _exportExecl(fname){
            ...
            this.exportCommonTemplate(this.tableInfoConf.columns,this.dataList,fileName)
         },
        _functionClick(item){
            let _this=this;
