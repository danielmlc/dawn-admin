...
<div slot="content">
  <yl-columnlay>
              <div slot="left"  >
                    <yl-panelpage isZone :helpIsShow="false" :treeLoading="treeLoading" @reload="_treeReload" :reloadIsShow="true" :titleName="'字典树'" :icon="'icon-tree'" :widthNum="'210px'" >
                        <div slot="content">
                ...
                <div slot="right" >
                    <yl-layout>
                        ...
                        <yl-toolbar>
                            <el-button-group>
                                    <el-button type="primary" v-permissionSetting="'CommonDataDictionarys.Create'"   icon="el-icon-plus" size="small"  @click="_add" >添加</el-button>
                                    <el-button type="primary" v-permissionSetting="'CommonDataDictionarys.Edit'"   icon="el-icon-edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                                    <el-button type="danger"  v-permissionSetting="'CommonDataDictionarys.Delete'"   icon="el-icon-delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                                </el-button-group>
                        </yl-toolbar>
                        </div>
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'isLeaf', label: '子节点', width:120, scopedSlot: 'isLeaf',    } }, 
