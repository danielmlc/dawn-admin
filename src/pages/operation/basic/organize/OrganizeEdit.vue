            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="上级名称" prop="parentId">
                        <yl-organizeTree v-model="formModel.parentId" @getCurrentNode="_getParentOrg" :placeholder="'请选择上级名称'" :isexpand="false"  :defaultText="defaultTxt"></yl-organizeTree>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item v-if="isZhbVisible" label="指挥部" prop="zhbId" style="width:100%;">
                        <el-select v-model="formModel.zhbId" :clearable="true" placeholder="请选择指挥部" style="width:100%;" @change="_change">
...
export default {
    ...
    methods: {
        ...
        _getParentOrg(node){
            this.formModel.parentName=node.text;
            this._getParametersTreeList(node.funcCode);   
        },
        _getParametersTreeList(type) {
            var _this = this;
            let params={};
            ...
            params.sorting='';
            requestGetParametersTreeList(params).then(data => {
                if (data.success) {
    ...
    beforeMount() {
        ...
        this.defaultTxt=this.selectRow.parentName;
    },
    mounted() {
        this.formModel.zhbId=(this.selectRow.zhbId==this.guidOfNull()?'':this.selectRow.zhbId);  
    },
    components: {
