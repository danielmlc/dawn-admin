        ...
        <yl-toolbar>
            <el-button-group>
                    ...
                    <el-button type="danger"     icon="el-icon-delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                     <el-button type="primary"    icon="el-icon-edit"  size="small"  @click="_editdefault">编辑默认门户</el-button>
                </el-button-group>
        </yl-toolbar>   
        </div>
...
import Edit from './HomePageConfEdit';
    ...
    methods:{
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                fetch({
                    url:'/api/services/app/homePageConf/DeleteMainObject',
                    method:'post',
                    data:obj
                }).then(data =>{
                        if(data.success){
