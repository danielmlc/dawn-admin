    ...
    <yl-columnlay>
        ...
        <div slot="right" >
            <yl-layout>
                ...
                <yl-toolbar>
                    <el-button-group>
                            <el-button type="primary" v-permissionSetting="'InformationPublishs.Create'"   icon="el-icon-plus" size="small"  @click="_add" >添加</el-button>
                            <el-button type="primary" v-permissionSetting="'InformationPublishs.Edit'"   icon="el-icon-edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                            <el-button type="danger"  v-permissionSetting="'InformationPublishs.Delete'"   icon="el-icon-delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                        </el-button-group>
                </yl-toolbar>
                </div>
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'content', label: '预览', width:80,scopedSlot:"content"  } },   
                                {attr: { prop: 'clickTimes', label: '点击次数', width:120,scopedSlot:"clickTimes"  } },   
                                {attr: { prop: 'useful', label: '有帮助', width:100,  } },   
                                {attr: { prop: 'unUseful', label: '无帮助', width:100,  } },  
