<template>
<yl-panelpage :titleName="'业务模块自定义配置'" >
<div slot="content">
    <yl-layout>
        <div slot="fristbox" >
            <yl-toolbar>
...
import Edit from './userModuleConfEdit';
...
export default {
    ...
    methods:{
        ...
        _getMainPageList(){
                ...
                fetch({
                    url:'/api/services/app/usermoduleConf/getMainPageList',
                    method:'post',
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                fetch({
                    url:'/api/services/app/usermoduleConf/DeleteMainObject',
                    method:'post',
                    data:obj
                }).then(data =>{
                        if(data.success){
        ...
        _getToken(){
         ...
         _push(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/usermoduleConf/Push',
                        method:'post',
            ...
            _pull(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/usermoduleConf/GetUserModuleConfForEdit',
                        method:'post',
                        data:[ 
