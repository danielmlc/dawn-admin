...
<yl-panelpage :titleName="'模块列信息说明'" :reloadisShow="false" :fullscreenisShow="true" >
    <div slot="content">
                <yl-layout>
                    <div slot="fristbox" >
                        <el-alert
                            title="提示：表和模块都选才可以添加，修改不影响，删除的时候会删除当前条件下的所有数据，请谨慎操作!"
                            type="warning">
                        </el-alert>
                        <yl-toolbar>
                            <el-form  :inline="true"  >
                            ...
                            <el-form-item  class="form-content-vertical">
                                 ...
                                 <el-form-item class="form-content-vertical">
                                    <el-input  placeholder="版本号"  style="width:120px" v-model="versionNum"></el-input>
                                </el-form-item>
                                <el-form-item class="form-content-vertical">
                        ...
                        <yl-toolbar>
                            <el-button-group>
                                <el-button type="primary" v-permissionSetting="'ModuleColInfoConfigs.Create'"   icon="el-icon-plus" size="small" :disabled="this.tableName===''" @click="_add" >添加</el-button>
                                <el-button type="primary" v-permissionSetting="'ModuleColInfoConfigs.Edit'"   icon="el-icon-edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                                <el-button type="danger"  v-permissionSetting="'ModuleColInfoConfigs.Delete'"   icon="el-icon-delete" size="small"  :disabled="tableName===0" @click="_delete" >删除</el-button>
                                <el-button type="success"  icon="yl-icon icon-file-excel" size="small" v-permissionSetting="'show'"  @click="_exportExecl" >导出execl</el-button>
                            </el-button-group>
                        </yl-toolbar>
                    </div>
         ...
         <el-dialog ref="mainDialog" title="编辑" 
                    ...
                    <Edit :colInfo="tableCol" :moduleInfo="moduleInfos" :versionNum="versionNum"  @close="_close"  v-if="addFormVisible"></Edit>
         </el-dialog>
    </div>
</yl-panelpage>
</template>
...
export default {
    ...
    methods:{
       ...
       _getMainPageList(){
            ...
            inputArr.push({key:"VersionNum",op:"EQ",value:this.versionNum})
            this.mainInput.addqueryConditionItem(inputArr);
