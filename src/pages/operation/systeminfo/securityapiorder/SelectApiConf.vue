<template>
<yl-layout style="height:570px;">
                <div slot="fristbox">
                    <yl-toolbar>
                        <el-form :inline="true">
                            <el-form-item class="form-content-vertical">
                                <el-input placeholder="模块标识" 
                                          size="small" 
                                          style="width:200px"
                    ...
                    <yl-toolbar>
                        <el-button-group ref="funtoolbar">
                           <el-button type="success" icon="el-icon-refresh" size="small" @click="_updateApi">更 新</el-button>
                            <el-button type="primary"  name="add" icon="el-icon-plus" size="small" @click="_onSubmit" :disabled="selectRows.length===0" :loading="loading">确 定</el-button>
                        </el-button-group>
                    </yl-toolbar>
                </div>
      ...
      get() {
        return {
          ...
          columns: [
            ...
            { attr: { prop: "tableName", label: "模块标识", width: 120 } },
            { attr: { prop: "apiUrl", label: "ApiUrl" } },
