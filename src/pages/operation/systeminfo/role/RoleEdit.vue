<template>
        <el-form  :model="formModel" status-icon  :rules="rules"  ref="formModel" label-width="100px">
            <el-tabs v-model="activeName" @tab-click="_handleClick"  >
                <el-tab-pane label="角色属性" name="first" style="height:250px;">
                    <el-form-item label="上级角色" prop="parentId" >
                        <yl-roleTree v-model="formModel.parentId" @getCurrentNode="_parentChange"></yl-roleTree>
                    </el-form-item>
                ...
                <el-tab-pane label="功能权限" name="second" class="yl-tab-pane" >
                        <el-tree  
...
export default {
    ...
    methods:{
        ...
        _parentChange(node){
            this.formModel.parentId=node.id;
        },
         _resetForm() {
