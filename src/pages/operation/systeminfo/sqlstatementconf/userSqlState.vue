...
import Edit from './userSqlStateEdit';
...
export default {
    ...
    methods:{
        _getSqlStatePageList(){
                ...
                fetch({
                    url:'/api/services/app/userSQLStatementConf/getMainPageList',
                    method:'post',
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                fetch({
                        url:'/api/services/app/userSQLStatementConf/DeleteMainObject',
                        method:'post',
                        data:obj
                    }).then(data =>{
                        if(data.success){
        ...
        _getToken(){
         ...
         _push(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/userSQLStatementConf/Push',
                        method:'post',
            ...
            _pull(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/userSQLStatementConf/GetMainObjectForEdit',
                        method:'post',
                        data:params
                    },
                    {
