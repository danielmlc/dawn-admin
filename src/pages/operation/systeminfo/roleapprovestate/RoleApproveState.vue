               ...
               <div slot="left"  >
                ...
                <div slot="right" >
                    <yl-layout>
                        ...
                        <yl-toolbar>
                            <el-button-group>
                                    <el-button type="primary" v-permissionSetting="'ApproveFlows.Create'"   icon="el-icon-plus" size="small"  @click="_add" >添加</el-button>
                                    <el-button type="primary" v-permissionSetting="'ApproveFlows.Edit'"   icon="el-icon-edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                                    <el-button type="danger"  v-permissionSetting="'ApproveFlows.Delete'"   icon="el-icon-delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                                </el-button-group>
                        </yl-toolbar>
                        </div>
            ...
            tableConfig: {
                    get () {
                        return {
                            ...
                            columns: [
                                {attr: { type: 'index',label: '序号', width:50,align: 'center',headerAilgn:'center' }},
                                // {attr: { prop: 'roleId', label: ' 角色id', width:120,  } }, 
                                 {attr: { prop: 'stateDesc', label: '审批标题', width:120,  } },    
                                {attr: { prop: 'roleName', label: '角色名称', width:120,  } },   
                                {attr: { prop: 'tableName', label: '表名', width:160,  } },  
                                {attr: { prop: 'moduleType', label: '类型', width:100,  } },   
                                ...
                                {attr: { prop: 'stateText', label: '状态文本值', width:140,  } },   
                                {attr: { prop: 'isState', label: '是否为初始值', width:120,  } },   
                                {attr: { prop: 'remark', label: '备注', width:180,  } },   
                            ]
                        }
                    }
                }
