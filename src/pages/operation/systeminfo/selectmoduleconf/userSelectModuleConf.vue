<template>
<yl-panelpage :titleName="'数据选择器配置'" >
<div slot="content">
    <yl-layout>
        <div slot="fristbox" >
                <yl-toolbar>
          ...
          <yl-toolbar>
                <el-form  :inline="true"  >
                        <el-form-item class="form-content-vertical">
                                 <el-input  placeholder="选择器标识" size="small" style="width:200px" v-model="searchModel.extensionOne"></el-input>
                        </el-form-item>
                        <el-form-item class="form-content-vertical">
...
import Edit from './userSelectModuleConfEdit';
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'extensionOne', label: '选择器标识'  ,width:150,  } },   
    ...
    methods:{
        ...
        _getMainPageList(){
                ...
                if(this.searchModel.menuCode!==''){
                     inputArr.push({key:"ExtensionOne",op:"LIKE",value:this.searchModel.extensionOne})
                }
                this.mainInput.addqueryConditionItem(inputArr);
                this.mainInput.inputModel.sorting="createTime DESC"
                fetch({
                    url:'/api/services/app/userselectModuleConf/getMainPageList',
                    method:'post',
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                fetch({
                    url:'/api/services/app/userselectModuleConf/DeleteMainObject',
                    method:'post',
                    data:obj
                }).then(data =>{
                        if(data.success){
        ...
        _getToken(){
         ...
         _push(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/userselectModuleConf/Push',
                        method:'post',
            ...
            _pull(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/userselectModuleConf/GetUserSelectModuleConfForEdit',
                        method:'post',
                        data:[ 
                            {dataField:"ExtensionOne",op:"EQ",dataValue:this.currentRows.extensionOne},
