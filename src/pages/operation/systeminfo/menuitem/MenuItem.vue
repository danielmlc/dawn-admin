<template>
    <yl-panelpage  :titleName="'菜单管理'"  :reloadisShow="false" :fullscreenisShow="true">
        <div slot="content">
            <yl-columnlay>
                <div slot="left" >        
                   <yl-menuItemTreeWithPanel :highlightCurrent="true"  :treeLoading="treeLoading" :reloadIsShow="true" v-model="menuItemWithPanel" @getCurrentNode="_getCrureentNode"  :placeholder="'请选择'"   style="width:200px"> </yl-menuItemTreeWithPanel>
                </div>
                <div slot="right" >
                        <yl-layout >
                        <div slot="fristbox" >
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'menuName', label: '菜单名称', width:150, } },
                                 {attr: { prop: 'menuCode', label: '菜单代码', width:120,  } },
                                {attr: { prop: 'funcCode', label: '功能代码', width:220} },
                                {attr: { prop: 'menuIcon', label: '图标', scopedSlot: 'menuIcon', width:70,align: 'center',headerAlign:'center' } },
                                {attr: { prop: 'sortCode', label: '排序', width:80,align: 'center',headerAlign:'center'} },
                                {attr: { prop: 'showFlag', label: '状态',  width:70, scopedSlot: 'showFlag',} },
                                {attr: { prop: 'url',      label: '配置路径', width:220} },
                                {attr: { prop: 'tableName', label: '对应表名', width:220} },
