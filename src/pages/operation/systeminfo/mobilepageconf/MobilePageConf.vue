<template>
<yl-panelpage :titleName="'APP配置模块'" >
<div slot="content">
    <yl-layout>
        <div slot="fristbox" >
               <yl-toolbar>
          ...
          <yl-toolbar>
                <el-form  :inline="true"  >
                        <el-form-item class="form-content-vertical">
                         ...
                         <el-form-item class="form-content-vertical">
                              <el-input placeholder="菜单编码" v-model="searchModel.menuCode"   style="width:150px"></el-input>
                        </el-form-item>
                        <el-form-item class="form-content-vertical">
                        <el-input  placeholder="页面名称"  style="width:200px" v-model="searchModel.pageName"></el-input>
                        </el-form-item>
                         <el-form-item  class="form-content-vertical" >
                                 <el-select 
                                        ...
                                        style="width:150px"
                                        clearable 
                                        v-model="searchModel.extensionTwo" placeholder="请选择模块类型">
                                    <el-option :key="1"
                                        label="assemblePage"
                                        value="assemblePage">
                                    </el-option>
                        ...
                        <el-form-item class="form-content-vertical">
                            <el-button type="primary" icon="el-icon-search"   @click="_reload">查 询</el-button>
                        </el-form-item>
                </el-form>
          </yl-toolbar>
        <yl-toolbar>
...
import Edit from './MobilePageConfEdit';
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'extensionTwo', label: '模块类型', width:120, scopedSlot:'extensionTwo' } },
                                {attr: { prop: 'menuCode', label: '菜单编码', width:120,  } },
                                {attr: { prop: 'pageName', label: '页面编码', width:120,  } },
                                {attr: { prop: 'extensionOne', label: '页面标题', width:120,  } },
                                ...
                                {attr: { prop: 'pageConf', label: '配置内容'  ,width:220,  } },  
                            ]
                        }
                    }
                }
    ...
    methods:{
        ...
        _getMainPageList(){
                ...
                if(this.searchModel.menuCode!==''){
                     inputArr.push({key:"MenuCode",op:"EQ",value:this.searchModel.menuCode})
                }
                if(this.searchModel.extensionTwo!==''){
                     inputArr.push({key:"ExtensionTwo",op:"EQ",value:this.searchModel.extensionTwo})
                }
                this.mainInput.addqueryConditionItem(inputArr);
                this.mainInput.inputModel.sorting="createTime desc"
                fetch({
                    url:'/api/services/app/mobilePageConf/getMainPageList',
                    method:'post',
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                fetch({
                    url:'/api/services/app/mobilePageConf/deleteMainObject',
                    method:'post',
                    data:obj
                }).then(data =>{
                        if(data.success){
        ...
        _getToken(){
         ...
         _push(row){
                ...
                fetch(
                    {
                        url:'/api/services/app/mobilePageConf/Push',
                        method:'post',
            ...
            _pull(row){
                ...
                let params={};
                params.queryConditionItem=data;
                fetch(
                    {
                        url:'/api/services/app/mobilePageConf/GetMainObjectForEdit',
                        method:'post',
                        data:params
                    },
                    {
