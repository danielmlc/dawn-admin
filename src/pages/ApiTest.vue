...
<el-form :model="formModel"  :rules="rules"  ref="formModel"  label-width="100px" style="padding-top:20px">
         ...
         <el-form-item label="参数" prop="data" >
		  ...
		  <el-col :span="6">
			...
			<el-form-item  >
				 <el-button type="primary" @click="_cleartoken" :loading="loading">清除token</el-button>
			</el-form-item>
		 </el-col>
		 <el-col :span="18">
			<el-form-item  label="是否带参数">
				  <el-switch v-model="isParams" :active-value="true"  :inactive-value="false" on-text="是" inactive-text="否" @change="_change"> </el-switch>
			</el-form-item>
		 </el-col>
		 <el-col :span="24">
		...
		data() {
		     ...
		     methods:{
			     ...
			     _onSubmit(){
					...
					axios.defaults.timeout=window.getClientObj().sysConf.timeout;
